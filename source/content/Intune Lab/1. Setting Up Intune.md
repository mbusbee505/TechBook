...
First, Go to the sign up page for [Microsoft Defender for Endpoint P2 Free Trial](https://go.microsoft.com/fwlink/?linkid=2225630) and sign up using the same login you used for the rest of the lab.
